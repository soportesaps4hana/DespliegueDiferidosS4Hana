...
define view entity Z_DEBITOS_CREDITOS_AUX_N6
  with parameters
    FechaInicial : datum,
    FechaFinal   : datum
...
group by  Sumatoria.GLAccount, Sumatoria.AccountingDocumentItem 
    /*
  as select distinct from Z_BALANCE_TERCEROS_HBT (FechaInicio : $parameters.FechaInicial , FechaFin : $parameters.FechaFinal) as Sumatoria
 inner join Z_SOCIOS_BALANCE as Socios on Socios.NitSN = Sumatoria.Tercero_Referencia  or Socios.SocioBP = Sumatoria.YY1_HBT_Tercero_S4_COB
